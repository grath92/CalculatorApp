...
import InputNumButton from './inputNumButton';
  ...
  handleInput = (input) => {
    ...
    switch (input) {
      ...
      case '=':
          ...
          let res = eval(firstValue + realOperator + secondvalue)
          this.setState({
            displayValue: res % 1 === 0 ? res : res.toFixed(2),
            firstValue: res % 1 === 0 ? res : res.toFixed(2),
            secondvalue: '',
            operator: null,
            nextValue: false
          })
      ...
      case 'DEL':
          let strng = displayValue.toString();
          let deletedString = strng.substr(0, strng.length - 1);
